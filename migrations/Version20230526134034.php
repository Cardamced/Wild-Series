 ...
 */
final class Version20230526134034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD season_id INT DEFAULT NULL, DROP season');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD season VARCHAR(255) NOT NULL, DROP season_id');
